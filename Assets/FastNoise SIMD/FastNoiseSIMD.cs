...
public class FastNoiseSIMD
{
    ...
    public void FillSampledNoiseSetVector(float[] noiseSet, VectorSet vectorSet, float xOffset = 0f, float yOffset = 0f,
        float zOffset = 0f)
    {
    ...
    public class VectorSet
    {
            ...
            int samplingScale = 0)
        {
            ...
            nativePointer = NewVectorSet(vectorSetArray, vectorSetArray.Length, samplingScale, sampleSizeX, sampleSizeY,
                sampleSizeZ);
        }
